var ImageUploader = (function () {
	function ImageUploader(c, photo_field, increment, id, image_name, table) {
		this._allowed_ext = ['jpg', 'jpeg', 'png', 'gif'];
		this._upload_url = '/administrator-cms/ajax/images/updatePhoto';
		this._table = table;
		this._container = c;
		this._path = c.querySelectorAll('#path_image')[0].value;
		this._record_id = id;
		this._record_name = image_name;
		this._record_photo_field = photo_field;
		this._record_increment = increment;
	...
	ImageUploader.prototype.uploadImageFile = function (prop) {
		...
		data.append('photo_field', obj._record_photo_field);
		data.append('photo_link', obj._record_name);
		data.append('increment', obj._record_increment);
