...
class elFinderVolumeFTP extends elFinderVolumeDriver {
	 ...
	 *
	 * @param  StringClass  $raw  line from ftp_rawlist() output
	 * @return array
	 ...
	 *
	 * @param  StringClass  $raw  line from FTP LIST (MS-DOS style)
	 * @return array
	 * @author Naoki Sawada
	 **/
	 ...
	 *
	 * @param  StringClass  $perm  permissions string
	 * @return StringClass
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 *
	 * @param  StringClass  $target  link target
	 * @param  StringClass  $path    symlink path
	 * @return bool
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 * @return StringClass path to the new temporary directory or false in case of error.
	 */
	 ...
	 * 
	 * @param $remote_directory StringClass remote FTP path to scan for file and folders recursively
	 ...
	 * 
	 * @param $remote_directory StringClass remote FTP path to a source directory to download from.
	 * @param array $files list of files to download from remote directory.
	 * @param $dest_local_directory StringClass destination folder to store downloaded files.
	 ...
	 * @param $dirPath StringClass to directory to be erased.
	 * @return bool true on success and false on failure.
	 */
