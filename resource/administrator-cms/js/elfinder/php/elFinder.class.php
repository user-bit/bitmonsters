...
class elFinder {
	 ...
	 *
	 * @param  StringClass  command name
	 * @param  StringClass|array  callback name or array(object, method)
	 * @return elFinder
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 * 
	 * @param StringClass $key  netvolume key
	 */
	 ...
	 * 
	 * @param  StringClass $name   Plugin name (dirctory name)
	...
	* Get remote contents
	*
	* @param  StringClass   $url     target url
	* @param  int      $timeout timeout (sec)
	* @param  int      $redirect_max redirect max count
	* @param  StringClass   $ua
	* @param  resource $fp
	* @return StringClass or bool(false)
	...
	**/
	 ...
	 * 
	 * @param  StringClass $path Local path
	 * @return StringClass file type extension with dot
	 * @author Naoki Sawada
	 */
	 ...
	 * 
	 * @param  StringClass $volumeTempPath
	 * @return StringClass
	 * @author Naoki Sawada
	 */
	 ...
	 * 
	 * @param StringClass $tmpname  uploaded temporary file path
	 * @param StringClass $chunk    uploaded chunk file name
	 * @param StringClass $cid      uploaded chunked file id
	 * @param StringClass $tempDir  temporary dirctroy path
...
//		}
	...
	**/
	 ...
	 * 
	 * @param  StringClass $path server local path of target image
	 * @return bool
	 */
