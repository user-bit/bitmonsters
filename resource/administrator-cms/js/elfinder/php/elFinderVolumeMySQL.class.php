...
class elFinderVolumeMySQL extends elFinderVolumeDriver {
	 ...
	 * @param  StringClass  $name  object name
	 * @param  StringClass  $mime  mime type
	 * @return bool
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 *
	 * @param  StringClass $path  file path (id)
	 * @return StringClass
	 ...
	 *
	 * @param  StringClass  $path  file path
	 * @param  StringClass  $mode  open file mode (ignored in this driver)
