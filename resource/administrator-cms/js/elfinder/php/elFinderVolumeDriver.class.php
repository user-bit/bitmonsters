...
abstract class elFinderVolumeDriver {
	 ...
	 *
	 * @param  StringClass   $hash    file or folder hash to chmod
	 * @param  StringClass   $mode    octal string representing new permissions
	 * @return array|false
	 * @author David Bartle
	 **/
	 ...
	 * 
	 * @param StringClass $name  target option name
	 ...
	 * 
	 * @param StringClass $name  Plugin name
	 ...
	 *
	 * @param  StringClass  $cmd  command name
	 * @return bool
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 *
	 * @param  StringClass     $mime   mime type to check
	 ...
	 *
	 * @param  StringClass   $hash  file hash
	 * @return StringClass
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 *
	 * @param  StringClass   $hash  file hash
	 * @param  StringClass   $attr  attribute name
	 ...
	 * Return folder info
	 *
	 * @param  StringClass   $hash  folder hash
	 ...
	 *
	 * @param  StringClass   $hash  folder hash or empty string to get tree from root folder
	 * @param  int      $deep  subdir deep
	 * @param  StringClass   $exclude  dir hash which subfolders must be exluded from result, required to not get stat twice on cwd subfolders
	 * @return array|false
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 *
	 * @param  StringClass    $hash   directory hash
	 ...
	 *
	 * @param  StringClass   $dsthash  destination directory hash
	 * @param  StringClass   $name directory name
	 * @return array|false
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 *
	 * @param  StringClass   $dst  destination directory
	 * @param  StringClass   $name file name
	 * @return array|false
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 *
	 * @param  StringClass   $hash    file hash
	 * @param  StringClass   $suffix  suffix to add to file name
	 * @return array|false
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 *
	 * @param  Resource $fp      file pointer
	 * @param  StringClass   $dst     destination folder hash
	 * @param  StringClass   $src     file name
	 * @param  StringClass   $tmpname file tmp name - required to detect mime type
	 ...
	 * @param  StringClass  $source  file hash
	 * @param  StringClass  $dst     destination dir hash
	 ...
	 * 
	 * @param  array  $hashes
	 * @return StringClass archive path
	 * @author Naoki Sawada
	 */
	 ...
	 *
	 * @param  StringClass  $hash  archive hash
	 * @return array|bool
	 * @author Dmitry (dio) Levashov, 
	 * @author Alexey Sukhotin
	 **/
	 ...
	 * Resize image
	 *
	 * @param  StringClass   $hash    image file
	 * @param  int      $width   new width
	 * @param  int      $height  new height
	 * @param  int      $x       X start poistion for crop
	 * @param  int      $y       Y start poistion for crop
	 * @param  StringClass   $mode    action how to mainpulate image
	 * @param  StringClass   $bg      background color
	 ...
	 * 
	 * @param StringClass $baseTargetHash
	 * @param StringClass $path
	 * @param array  $result
	 * @return boolean|StringClass
	 * @author Naoki Sawada
	 ...
	 *
	 * @param  StringClass  $path  rel file path
	 * @return StringClass
	 * @author Naoki Sawada
	 **/
	 ...
	 *
	 * @param  StringClass  $path    file path
	 * @param  StringClass  $suffix  suffix append to name
	 * @return StringClass
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 * @param  StringClass $unknown       replaces character for unknown
	 * @return mixed
	 * @author Naoki Sawada
	 */
	 ...
	 * 
	 * @param  mixed  $var     target string or array var
	 * @param  StringClass $from    from character encoding
	 * @param  StringClass $to      to character encoding
	 * @param  StringClass $locale  local locale
	 * @param  StringClass $unknown replaces character for unknown
	 * @return mixed
	 */
	 ...
	 * 
	 * @param  StringClass       $path for get unique file to a path
	 * @return StringClass|false
	 * @author Naoki Sawada
	 */
	 ...
	 * 
	 * @param  StringClass $path path need convert encoding to server encoding
	 * @return StringClass
	 * @author Naoki Sawada
	 */
	 ...
	 * @param  StringClass $dir     destination directory (for recurcive)
	 * @return StringClass|false    saved path name
	 * @author Naoki Sawada
	 */
	 ...
	 *
	 * @param  StringClass  $path  file path
	 * @param  StringClass  $name  attribute name (read|write|locked|hidden)
	 ...
	 *
	 * @param StringClass $dir  parent dir path
	 * @param StringClass $name new file name
	 * @return bool
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 * Return fileinfo 
	 *
	 * @param  StringClass  $path  file cache
	 * @return array
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 *
	 * @param  StringClass  $mime1  mimetype
	 * @param  StringClass  $mime2  mimetype
	 * @return bool
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 *
	 * @param  StringClass  $src   source path
	 * @param  StringClass  $dst   destination dir path
	 * @param  StringClass  $name  new file name (optionaly)
	 * @return StringClass|false
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 *
	 * @param  Object  $volume       source volume
	 * @param  StringClass  $src          source file hash
	 * @param  StringClass  $destination  destination dir path
	 * @param  StringClass  $name         file name
	 * @return StringClass|false
	 * @author Dmitry (dio) Levashov
	 **/
	 ...
	 *
	 * @param  StringClass  $path  thumnbnail path
	 * @param  array   $stat  file stat
	 ...
	 * @param  StringClass   $bgcolor            square background color in #rrggbb format
	 * @param  StringClass   $destformat         image destination format
	 * @param  int      $jpgQuality         JEPG quality (1-100)
	 * @return StringClass|false
	 * @author Dmitry (dio) Levashov
	 ...
	 *
	 * @param  StringClass  $command       command line
	 ...
	 *
	 * @param  StringClass  $stat  file stat
	 * @return void
	 * @author Dmitry (dio) Levashov
	 * @author Naoki Sawada
	 * @author Troex Nevelin
	 ...
	 * @param StringClass $filename The path to save the file to.
	 * @param StringClass $destformat The Image type to use for $filename
	 * @param StringClass $mime The original image mime type
	 * @param int    $jpgQuality  JEPG quality (1-100)
	 */
	 ...
	 *
	 * @param resource $image gd image resource
	 * @param StringClass $bgcolor background color in #rrggbb format
	 */
	...
	*
	* @param  StringClass  $haystack  The string being checked.
	* @param  StringClass  $needle    The string to find in haystack.
	...
	**/
	 ...
	 * 
	 * @param StringClass $path  target path
	 * @param StringClass $base  base path
	 * @return StringClass
	 */
	 ...
	 *
	 * @param StringClass $dir Target dirctory path
	 * @return boolean
	 * @author Naoki Sawada
	 */
	 ...
	 * @param  StringClass        $dir      target dir
	 * @param  array         $files    files names list
	 * @param  StringClass|object $zipPath  Zip archive name
	 * @return void
	 * @author Naoki Sawada
	 */
	 ...
	 * 
	 * @param  StringClass $zipPath  Zip archive name
	 * @param  StringClass $toDir    Extract to path
	 * @return bool
	 * @author Naoki Sawada
	 */
	 ...
	 *
	 * @param  StringClass  $path  file path
	 * @param  StringClass  $mode  octal string such as '0755'
	 * @return bool
	 * @author David Bartle,
	 **/
